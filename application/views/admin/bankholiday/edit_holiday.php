    ...
    <div class="container-fluid"> 
        <div class="card">
            <div class="card-body">
                ...
                <?php } ?>
                <form enctype="multipart/form-data" name="add_holiday" id="add_holiday" method="post" action="<?php echo base_url('admin/Bankholiday/updateHoliday/').$holiday[0]['id'];?>" style="width: 100%;">  
                    <div class="row">
                        <div class="col-md-6" style="padding-left: 36px">
                            <div class="form-group">
                                <label for="Location">Date</label> 
                                <input class="form-control" autocomplete="off" required type="text"  id="from-datepicker" name="start_date" value="<?php echo date("d/m/Y",strtotime($holiday[0]['date'])); ?>">
                            </div>
                        </div>
