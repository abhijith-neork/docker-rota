  ...
  var login_user_designation=<?php echo $login_user_designation;?>;
          ...
          <div class="col-4">
                    ...
                    <table  class="table table-bordered table-striped">
                        <thead>
                          <tr>
                            <th><?php echo "EMPLOYEES";?></th>
                            
                          </tr>
                        </thead>
                        <tbody>
                         <!--  <?php  print_r(json_decode($resources));?> -->
                        <!--   <?php  print_r(json_decode($weekEvents));?> -->
                          
<!--                             <?php foreach (json_decode($resources) as $resource) {?>

                              <tr>  
                                  <td><?php print_r($resource->title);?></td> 
