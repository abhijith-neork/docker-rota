                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Edit Rota Settings</li>
                        </ol>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-body">
                        <h3 class="card-subtitle" style="padding-bottom: 40px;">Edit Rota Settings</h3>
                        <div class="row">
                            <div class="col-md-1">
                        ...
                        <input type="hidden" class="start_date form-control" name="start_date" id="start_date" value="<?php echo $start_date ?>">
                        <input type="hidden" class="end_date form-control" name="end_date" id="end_date" value="<?php echo $end_date ?>">
...
body {
  ...
  var unit_id=<?php print $unit_select;?>;
          ...
          <div class="row"> 
              <div class="col-md-6">
                  <button type="button" data-action="update" class="btn btn-success mr-2 add" id="add" style="float: right;">Update Settings</button>
              </div>
              <div class="col-md-6">
              </div>
          </div>
