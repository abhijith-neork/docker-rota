        ...
        <div class="card-body">
            <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                                                            ...
                                                            <ol class="breadcrumb">
                                                                ...
                                                                <li class="breadcrumb-item active">Add Daily Census</li>
                                                            </ol>
                    </div>
            ...
            <div class="col-md-6" style="padding-left: 36px">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" name="date" id="from-datepicker" value="<?php echo $date;?>" placeholder="Select date"> 
                                                </div>
            </div>
            </div>
            <div class="row">
