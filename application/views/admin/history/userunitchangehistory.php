                    ...
                    <div class="col-md-6 col-8 align-self-center">
                                                            ...
                                                            <ol class="breadcrumb">
                                                                <?php if(in_array($this->session->userdata('user_type'),$this->config->item('group_id'))){?>
                                                                 ...
                                                                 <?php }?>
                                                                <li class="breadcrumb-item active">User Unit Change History</li>
                                                            </ol>
                    </div>
                                    ...
                                    <div class="table-responsive m-t-40">
                                            <table id="myTable" class="table table-bordered table-striped">
                                                ...
                                                <!-- <tbody> 
                                                    ...
                                                    { ?> 
                                                    <tr>
                                                    	<?php $old_unit=getUnitold($use['Previous_unit']);
                                                              $new_unit=getUnitold($use['Current_unit']);
                                                              $updated_user=getUpdateduser($use['Updated_by']);
                                                        ?>
                                                    	                            <td><?php echo $use['User_id'];?></td>  
                                                    	                            <td><?php echo $use['fname']." ".$use['lname'];?></td>
                                                                                    <td><?php echo $old_unit[0]['unit_name'];?></td>
                                                                                    <td><?php echo $new_unit[0]['unit_name'];?></td>
