                    ...
                    <div class="col-md-6 col-8 align-self-center">
                                                            ...
                                                            <ol class="breadcrumb">
                                                                <?php if(in_array($this->session->userdata('user_type'),$this->config->item('group_id'))){?>
                                                                 ...
                                                                 <?php }?>
                                                                <li class="breadcrumb-item active">User Rates Change History</li>
                                                            </ol>
                    </div>
                                            ...
                                            <table id="myTable" class="table table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                                                   ...
                                                                                   <!--  <th>Night Rate</th>
                                                                                    <th>Day Saturday Rate</th> 
                                                                                    <th>Day Sunday Rate</th> 
                                                                                    <th>Weekend Night Rate</th> -->
                                                                                    <th>Updation Date</th>
                                                                                    <th>Updated By</th>
                                                    </tr>
                                                </thead>
