		...
		<div class="card">
			<div class="card-body">
				<div class="row page-titles">
					<div class="col-md-6 col-8 align-self-center">
						<h3 class="text-themecolor mb-0 mt-0">Add Shift</h3>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a
								href="<?php echo base_url();?>admin/manageshift/">Manage Shift</a></li>
            ...
            <div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<form enctype="multipart/form-data" name="add" id="add" method="post" action="<?php echo base_url('admin/Shift/');?>addshift" style="width: 50%;">
									<div class="form-group">
										<label for="shift_name">Shift name</label> <input type="text"
											class="form-control shift_name" id="shift_name"  required="required"  name="shift_name"
											placeholder="Enter shift name" value="<?php echo $this->input->post('shift_name'); ?>"  >
									</div>
									<div class="form-group">
										<label for="shift_shortname">Shift short name</label>
                                        <input type="text"
                                            class="form-control shift_shortname" id="shift_shortname"  required="required"  name="shift_shortname"
                                            placeholder="Enter shift short name" value="<?php echo $this->input->post('shift_shortname'); ?>"  >
									</div>  
									<div class="row">
                                            <div class="col-md-4"> 
                                                <div class="form-group">
                                                	...
                                                	<p><h7>Hours:</h7></p>
                                                    <select class="custom-select form-control required start_time_hour" required="required" id="wstart_time2" name="wstart_time2">
                                                         <?php $i='';$n=24;
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <label for="wstart_time12"><br></label>   
                                                	<p><h7>Minutes:</h7></p>
                                                    <select class="custom-select form-control required start_time_min" required="required" id="wstart_time12" name="wstart_time12">
                                    ...
                                    <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <p><h7>Hours:</h7></p>
                                                    <select class="custom-select form-control required end_time_hour" required="required" id="wend_time2" name="wend_time2">
                                                        <?php $i='';$n=24;
                                                        for($i=1;$i<=$n;$i++) { if($i<10){?>
                                             ...
                                             <div class="col-md-4">
                                                ...
                                                <label for="wend_time12"><br></label>   
                                                    <p><h7>Minutes:</h7></p>
                                                    <select class="custom-select form-control required end_time_min"  required="required" id="wend_time12" name="wend_time12">
                                                    <option value="00"<?php if($this->input->post('wend_time12')=="00"){?> selected="selected" <?php }?>>00</option>
                                                    <option value="15"<?php if($this->input->post('wend_time12')=="15"){?> selected="selected" <?php }?>>15</option>
                                                    <option value="30"<?php if($this->input->post('wend_time12')=="30"){?> selected="selected" <?php }?>>30</option>
                                                    <option value="45"<?php if($this->input->post('wend_time12')=="45"){?> selected="selected" <?php }?>>45</option>
                                                     </select>
                                                </div>
                                            </div>  
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required="required" class="form-control" name="shift_type" id="shift_type" class="shift_type">  
                                            ...
                                            <option value="1"<?php if($this->input->post('shift_type')=="1"){?> selected="selected" <?php }?>>Full day</option>
                                            <option value=".5"<?php if($this->input->post('shift_type')==".5"){?> selected="selected" <?php }?>>Half day</option>  
                                        </select>
                                    </div>
                                     <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Enter targeted hours" value="<?php echo $this->input->post('targeted_hours'); ?>" required="required" readonly>
                                    </div>  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Enter unpaid break hours (hh:mm)" value="<?php echo $this->input->post('unpaid_break_hours'); ?>"  required="required">
                                    </div>  
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Enter total targeted hours" value="<?php echo $this->input->post('total_targeted_hours'); ?>" required="required" readonly>
                                    </div>  
                                    <div class="form-group"> 
                                        <div class="example">
                                            <h5 class="box-title">Select background color</h5> 
                                               <input type="text" name="back-color" id="back-color" value="<?php echo $this->input->post('back-color'); ?>" class="complex-colorpicker form-control" value="#ffffff" /> 
                                        </div> 
                                    </div>
                                    <div class="form-group"> 
                                        <div class="example">
									...
									&nbsp;
									<button type="submit" class="btn btn-primary" id="try">Add</button>
								</form>
							</div>
						</div>
					</div>
