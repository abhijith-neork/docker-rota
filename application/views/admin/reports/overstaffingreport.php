            ...
            <div class="row"> 
                ...
                <table id="myTable" class="table table-bordered table-striped">
                    ...
                    <?php foreach ($dates as $date) { ?>
                        <tr>
                            <?php $day_count = countDayShiftStaffs($date,$unit_ids);?>
                            <?php $night_count = countNightShiftStaffs($date,$unit_ids);?>
                            <?php $day_overstaffed = ($day_count-$day_shift_max)?>
                            <?php $night_overstaffed = ($night_count-$night_shift_max)?>
                            <td><?php echo date("d/m/Y",strtotime($date));?></td>
                            <td><?php echo $day_shift_max;?></td>
                            <td><?php echo $day_count;?></td>
                            <?php if ($day_overstaffed > 0 ) { ?>
                                <td><?php echo $day_overstaffed;?></td>
                            <?php } else { ?>
                                <td></td>
                            <?php } ?>
                            <td><?php echo $night_shift_max;?></td>
                            <td><?php echo $night_count;?></td>
                            <?php if ($night_overstaffed > 0 ) { ?>
                                <td><?php echo $night_overstaffed;?></td>
                            <?php } else { ?>
                                <td></td>
                            <?php } ?>
                        </tr>
