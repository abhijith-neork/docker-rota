...
<div class="col-md-2">
<div class="form-group" style="padding-right: 90px;padding-top: 30px;width: 200px;">
<button type="button" class="search btn float-right hidden-sm-down btn-success" id="search" onclick="tableToExcel('testTable', 'W3C Example Table')" style="width: 150px;">Export to Excel</button>
</div>
</div>
<?php } ?>
</div>
...
<thead>
<tr>
<th style="padding-right:180px;padding-left: 50px;position: sticky;left: 0px;background: #fff;z-index: 9;border: solid 1em #dcd6d6;border-width:thin;"><centre>Name</centre></th>
...
<tbody>
<tr class="weeks" style="border: solid 1em #dcd6d6;border-width:thin;">
<td style="position: sticky;left: 0px;background: #fff;border: solid 1em #dcd6d6;border-width:thin;"><center>Week No</center></td>
<td></td>
<td></td>
<td></td>
...
<table class="table table-bordered table-striped">
    <tr>
        ...
        <td class="child">
            ...
            <div><span style="padding-left: 8px;"><label style="font: bold;"><?php echo $date_on_sunday; ?></label></span></div>
...
?>
<tr>
<td style="position: sticky;left: 0px;background: #fff;border: solid 1em #dcd6d6;border-width:thin;"><?php echo $staff['fname']?> <?php echo $staff['lname']?></td>
...
<td style="color:white;padding: 1px;" class="child-<?php echo $week_number?>">
<?php echo $hours['div'];?>
</td>
<?php } else { ?>
<td style="padding: 1px;width:">&nbsp;&nbsp;</td>
<?php } ?>
<?php } ?>
</tr></table>
</td>
...
if (!table.nodeType) table = document.getElementById("print-content")
