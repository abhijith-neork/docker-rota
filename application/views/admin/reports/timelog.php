               ...
               <!--  <div class="col-md-3" style="padding-left: 36px">
                    <div class="form-group">
                                    <label for="Location">Job role</label> 
                                        ...
                                        <option value="none"><?php echo "------Select job role-------"?></option>
                ...
                <div class="col-md-2" style="padding-right: 36px;">
                    <div class="form-group">
                            ...
                            <input class="start_date form-control"  type="text" name="start_date" id="start_date" name="start_date"  value="<?php echo "$start_date";?>">
                    </div>
                </div>
                <div class="col-md-2" style="padding-right: 36px;">
                    <div class="form-group">
                            <label for="Location">End date <span style="color: red;">*</span></label> 
                            <input class="end_date form-control"  type="text" name="end_date" id="end_date" name="end_date"  value="<?php echo "$end_date";?>">
                    </div>
                </div>
 ...
 //print_r($datenew);
                                                  ...
                                                  <?php if($pre_status==2){?>
                                                    ...
                                                    <tr title="<?php echo "--".$timelog[$i]['time_from']."-- From";?>">
                                                      ...
                                                      <!-- New edit by CHINCHU --> 
                                                      <td>
                                                          <?php echo corectDateFormat($timelog[$i]['timelogdate']).' '.getUserCheckInTime($timelog[$i]['user_id'],$timelog[$i]['timelogdate']);?>
                                                      </td>  
                                                      <!-- old code by SWARAJ <?php if($timelog[$i]['time_from']!='00:00:00') { ?>
