    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="row page-titles">
          <div class="col-md-6 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a
                href="<?php echo base_url();?>manager/profile">Home</a></li>
          ...
          <div class="col-12">
          <button  type="button" onclick="location.href='<?php echo base_url('manager/profile/');?>';" class="btn btn-cancel">Cancel</button>
