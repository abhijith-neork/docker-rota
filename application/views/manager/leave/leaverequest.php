                    ...
                    <div class="col-md-6">
                        <div class="card">               
                            ...
                            <form enctype="multipart/form-data" name="add" id="add"
                                method="post" action="<?php echo base_url('manager/leave/');?>applyLeave">
                                <div class="form-group">
                                    <label for="wdob2">Start date:</label>
                                    <input type="text" placeholder="dd/mm/yy" autocomplete="off" class="form-control" onkeydown="return false" id="start_date" value="<?php echo $this->input->post('start_date');?>" name="start_date" required="required">
                                <?php 
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="dd/mm/yy" autocomplete="off" class="form-control" onkeydown="return false" id="end_date" name="end_date" value="<?php echo $this->input->post('end_date');?>" required="required">
                                   <!-- <div class="row"> -->
                                            <!-- <div class="col-md-6">  
                                ...
                                <div class="form-group">
                                  ...
                                  <!--  <?php if($user[0]['annual_allowance_type']==1) {?>
                                    <input type="text" class="form-control required" id="total_days" value="<?php echo $this->input->post('total_days');?>" name="total_days" data-toggle="tooltip" title="Days will be update automatically" required="required" readonly>
                                    <?php } else { ?> -->
