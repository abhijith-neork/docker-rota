                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-3 col-4 align-self-center" style="padding-left: 31px;">
                        <button class="btn   btn-success"
                            onclick="location.href='<?php echo base_url();?>manager/leave/leaverequest'" style="width: 175px;margin-bottom: 9px;">                           
                            <i class="mdi mdi-plus-circle"></i> Apply Annual Leave
                        </button>
                        <div class="row">
                                                <button class="btn float-right hidden-sm-down btn-secondary"
                                                    onclick="location.href='<?php echo base_url();?>manager/profile'" style="height: 40px; width:120px;margin-left:10px;">
                                                    Back
                                                </button> <br>
                                            </div>
                    </div>
                                    ...
                                    <table  class="table table-bordered table-striped">
                                        ...
                                        <tbody>                                
                                           <?php $hours=getHoursByUser($user_id,$yr['year']);?>
                                            ...
                                            <td>
                                                <?php echo number_format($hours, 2) .' hours'?>
                                            </td>
                                            <td>
                                                <?php echo number_format($leave_remaining, 2).' hours'?>
                                            </td>  
                                        </tbody>
                                    </table>
                                <?php } }  }?>
        ...
        function(isConfirm){
          if (isConfirm) {
           // form.submit();          // submitting the form when user press yes
              window.location = baseURL+"manager/Leave/cancelleave/mob/"+id
          } else {
              return false;
          }
        });
