...
<head>
    ...
    <title><?php echo $site_title[0]['company_name'];?><?php echo $headername;  echo " - ".date("d/m/Y H:i:s"); ?> </title>
    <!-- Bootstrap Core CSS -->
   ...
   <!-- toast CSS -->
      <!-- Custom CSS -->
    <link href="<?php echo base_url();?>assets/plugins/jquery-asColorPicker-master/dist/css/asColorPicker.css" rel="stylesheet">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="#">
                        ...
                        <b>
                            ...
                            <!-- Dark Logo icon -->
                            <img style="height: 63px;" title="<?php echo $this->session->userdata('user_type'); ?>" src="<?php echo base_url();?>/assets/images/logo-icon1.jpeg" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img title="<?php echo $this->session->userdata('user_type'); ?>" src="<?php echo base_url();?>/assets/images/logo-light-icon.png" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span>
                         <!-- dark Logo text -->
                         <img style="width: 184px;" title="<?php echo $this->session->userdata('user_type'); ?>" src="<?php echo base_url();?>/assets/images/logo-text1.png" alt="homepage" class="dark-logo" />
                         <!-- Light Logo text -->    
                         <img  title="<?php echo $this->session->userdata('user_type'); ?>" src="<?php echo base_url();?>/assets/images/logo-light-text.png" class="light-logo" alt="homepage" /></span> </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                <!-- ============================================================== -->
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                ...
                                <?php if(in_array($this->session->userdata('user_type'),$this->config->item('group_id'))){?>
                                    <li><a href="<?php echo base_url();?>admin/user/edituser/<?php echo $this->session->userdata('user_id'); ?>"><i class="ti-user"></i> My Profile</a></li>
                                <?php } else {?>
            ...
            <div class="scroll-sidebar">
              ...
              <div class="profile-text"> <a href="#" class="dropdown-toggle link u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"> <?php echo $this->session->userdata('full_name'); ?> </a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                    <?php if(in_array($this->session->userdata('user_type'),$this->config->item('group_id')))  //admin header start
                    { ?> 
                        <li>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="flase" class="collapse">
                                <li>
                                    <a href="<?php echo base_url();?>admin/managerota" class="has-arrow"  aria-expanded="true">Create</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="<?php echo base_url();?>admin/Bankholiday/index" class="has-arrow"  aria-expanded="false"><i class="mdi mdi-account-star-variant"></i><span class="hide-menu">Manage Bank Holidays </a>
                       ...
                       <li>
                        ...
                        <li>
                            ...
                            <?php if(in_array($this->session->userdata('user_type'),$this->config->item('group_id')) || $this->session->userdata('user_type') ==6)  { ?> 
                                <li>
                         ...
                         <li>
                            ...
                            <ul aria-expanded="flase" class="collapse">
                                <!-- <li>
                                    <a href="<?php echo base_url();?>admin/History/Email_report" class="has-arrow"  aria-expanded="false">Check-in/Check-out Accuracy Report</a>
                                </li> -->
                                <li>
                                ...
                                <li>
                                    <a href="<?php echo base_url();?>admin/History/addresschangehistory" class="has-arrow"  aria-expanded="false">User Address</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="<?php echo base_url();?>admin/History/userrateschangehistory" class="has-arrow"  aria-expanded="false">User Rates</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>admin/History/contracthourschangehistory" class="has-arrow"  aria-expanded="false">Contract Hours</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>admin/History/rotaupdatehistory" class="has-arrow"  aria-expanded="false">Rota Updates</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="<?php echo base_url();?>admin/company" class="has-arrow"  aria-expanded="false"><i class="mdi mdi-hospital-building"></i><span class="hide-menu">Company</a>
                    ...
                    { ?>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="flase" class="collapse">
                                ...
                                <li>
                                    <a href="" class="has-arrow viewrota_manager"  aria-expanded="false">View</a>
                                </li>
                                <?php }?>
                                <?php if($rota_availability_status == 1){?>
                                <li>
                                    <a href="" class="has-arrow availability_manager"  aria-expanded="false">Set Availability</a>
                                </li>
                                <?php }?>
                            </ul>
                        </li>
                        ...
                        <?php }?>
                        <?php
                            $manageuser_status = get_group_permission_status($this->session->userdata('user_type'),'Admin.User.View');
                        ?>
                        <?php if($manageuser_status == 1){?>
                        <li>
                            <a href="<?php echo base_url();?>admin/manageuser" class="has-arrow"  aria-expanded="false"><i class="mdi mdi-account"></i><span class="hide-menu">Manage Users </a>
                        </li>
                        <?php }?>
