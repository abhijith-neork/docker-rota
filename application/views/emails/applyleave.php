...
<p style="font-family: sans-serif;font-size: 14px;font-weight: normal;margin: 0;margin-bottom: 15px; text-align:center; padding-top:20px;"><strong>Dear <?php echo $user_name?></strong>,<br>
<br>

        <?php echo $subject;?><br><br>
        <?php echo $staff_count;?><br><br>
        <?php  $count = count($data) ?>
          <?php if($count!=0){?>
          	<p style="font-family: sans-serif;font-size: 14px;vertical-align: top;padding:0px 40px;"> <?php echo $staff_name ?> - Rota Schedule Details :</p>
   			<table style="margin:auto;border:solid; width:80%;font-weight:normal;font-family:sans-serif !important;">
   					...
   					{ ?>
   						<tr>
   							<td> <?php echo date("d/m/Y", strtotime($data[$i]['date']));?></td>
   							<td> <?php echo $data[$i]['shift_name'];?></td> 
   						</tr>
   					<?php }?>
		...
		<?php }?>
         ...
         <a href="<?php echo base_url();?>" target="_blank" title=" " style="padding: 7px 40px 7px 40px; margin: auto; display: table;color: #777777; font-size: 15px;font-family: sans-serif; font-weight: normal; border: 1px #00BCD4 solid;-webkit-border-radius: 25px;
-moz-border-radius: 25px;
border-radius: 25px; text-decoration: none; margin-bottom: 35px; margin-top: 35px;">Approve/Reject</a> 
...
Kind Regards,</p>
<p style="font-family: sans-serif;font-size: 12px;font-weight: normal;margin: 0;margin-bottom: 15px; text-align: center;padding: 0px 20px 0px 20px"><?php echo $staff_name ?></p>
<br>
