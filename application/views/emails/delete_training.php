...
<br>
        ...
        <?php echo $subject;?><br>
        <p style="color: #555555;font-family: sans-serif; font-size: 14px;  font-weight: normal; line-height: 1.3em; padding-left: 30px; padding-right: 30px;"> </p>
		   	   <p style="padding-left: 20%;"><?php echo $data;?><br></p>
