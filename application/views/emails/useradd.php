...
<br>
        ...
        <p style="color: #555555; font-size: 14px;font-family: sans-serif; font-weight: normal; line-height: 1.3em; padding-left: 30px; padding-right: 30px;">. Please click the verification button given below to verify your email ID and complete your registration.</p>
			   <a href="<?php echo $confirm_url;?>" target="_blank" title="<?php echo $site_title;?>" style="padding: 7px 40px 7px 40px; margin: auto; display: table;color: #777777; font-size: 15px;font-family: sans-serif; font-weight: normal; border: 1px #00BCD4 solid;-webkit-border-radius: 25px;
-moz-border-radius: 25px;
border-radius: 25px; text-decoration: none; margin-bottom: 35px; margin-top: 35px;">Verify</a>
			<p style="color: #555555; font-size: 14px;font-family: sans-serif; font-weight: bold; line-height: 1.3em; padding-left: 30px; padding-right: 30px;">
		   	Login credentials</p>
		   		<p style="color: #555555; font-size: 14px;font-family: sans-serif; font-weight: normal; line-height: 1.3em; padding-left: 30px; padding-right: 30px;">
		   	 	Username: <?php echo $to;?></p>
		   		<p style="color: #555555; font-size: 14px;font-family: sans-serif; font-weight: normal; line-height: 1.3em; padding-left: 30px; padding-right: 30px;">
		   		Password: <?php echo $password;?></p>
		   	<p style="color: #555555; font-size: 14px;font-family: sans-serif; font-weight: normal; line-height: 1.3em; padding-left: 30px; padding-right: 30px;">
		   	Didn’t create an account? It is likely that someone just typed in your email ID by accident. Please ignore this mail if it was not you.</p>
		   	<p style="color: #000000; font-size: 12px;font-family: sans-serif; font-weight: normal; line-height: 1.3em; padding-left: 30px; padding-right: 30px;">Thanks,</br>SMH-Rota Administrator.</p>
