...
<br>
        ...
        <?php echo $subject;?><br>
        <table width="80%" border="0" style="font-weight:normal;font-family:sans-serif !important;border:1px solid black;border-collapse: collapse;">
		   		<thead>
		   		    <tr> 
		   		...
		   		<tbody>
		   			...
		   			{ ?> 
		   			    <tr>
	   			        	...
	   			        	<td style="font-weight:normal !important;border:1px solid black;border-collapse: collapse;text-align:left;padding-left:5px;"><?php echo $data[$i]['shift_name']; ?></td>
	   			            <td style="font-weight:normal !important;border:1px solid black;border-collapse: collapse;text-align:left;padding-left:5px;"><?php echo corectDateFormat($data[$i]['date']); ?></td>
...
<!-- 		   <p style="color: #555555; font-size: 14px;font-family: sans-serif; font-weight: normal; line-height: 1.3em; padding-left: 30px; padding-right: 30px;">You can approve or reject allocation by clicking the below button</p>
			...
			<a href="<?php // echo $recover_url;?>" target="_blank" title=" " style="padding: 7px 40px 7px 40px; margin: auto; display: table;color: #777777; font-size: 15px;font-family: sans-serif; font-weight: normal; border: 1px #00BCD4 solid;-webkit-border-radius: 25px;
