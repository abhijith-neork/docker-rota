...
<br>
        ...
        <p style="color: #555555; font-size: 14px;font-family: sans-serif; font-weight: normal; line-height: 1.3em; padding-left: 30px; padding-right: 30px;">Please click on the button below to set your password.</p>
			   <a href="<?php echo $site_url;?>" target="_blank" title=" " style="padding: 7px 40px 7px 40px; margin: auto; display: table;color: #777777; font-size: 15px;font-family: sans-serif; font-weight: normal; border: 1px #00BCD4 solid;-webkit-border-radius: 25px;
-moz-border-radius: 25px;
border-radius: 25px; text-decoration: none; margin-bottom: 35px; margin-top: 35px;">Change your password.</a>
