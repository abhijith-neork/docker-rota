		   		...
		   		<tbody>
		   			...
		   			{ ?> 
		   			    <tr>
		   			        ...
		   			        <?php endif;?>
		   			        <?php if($data[$i]['shift_id'] != 0):?>
		   			            <td style="font-weight:normal !important;border:1px solid black;border-collapse: collapse;text-align:left;padding-left:5px;"><?php echo $data[$i]['date']; ?></td>
		   			        <?php endif;?>
		   			    </tr>  
		   			<?php
		   			}
