...
<p style="font-family: sans-serif;font-size: 14px;font-weight: normal;margin: 0;margin-bottom: 15px; text-align:center; padding-top:20px;"><strong>Dear <?php echo $supervisor_name;?></strong>,<br>
<br>
