...
<br>
        ...
        <p style="color: #555555; font-size: 14px;font-family: sans-serif; font-weight: normal; line-height: 1.3em; padding-left: 30px; padding-right: 30px;">
		   ...
		   <?php endif;?> 
		   	...
		   	<input type="hidden" value="<?php echo $details?>" id="recover_url">
		   	<input type="hidden" value="<?php echo $base_url?>" id="base_url">
		   	<p style="color: #555555; font-size: 14px;font-family: sans-serif; font-weight: normal; line-height: 1.3em; padding-left: 30px; padding-right: 30px;"></p>
		   	<a href="<?php echo $recover_url?>/1" style="padding: 7px 40px 7px 40px; margin: auto; display: table;color: #777777; font-size: 15px;font-family: sans-serif; font-weight: normal; border: 1px #00BCD4 solid;-webkit-border-radius: 25px;-moz-border-radius: 25px;border-radius: 25px; text-decoration: none; margin-bottom: 35px; margin-top: 35px;">Accept</a>
  			<a href="<?php echo $recover_url?>/2" style="padding: 7px 40px 7px 40px; margin: auto; display: table;color: #777777; font-size: 15px;font-family: sans-serif; font-weight: normal; border: 1px #00BCD4 solid;-webkit-border-radius: 25px;-moz-border-radius: 25px;border-radius: 25px; text-decoration: none; margin-bottom: 35px; margin-top: 35px;">Reject</a>
