...
<br>
        ...
        <?php $count = count($data) ?>
          <?php if($count!=0){?>
   			<table style="margin:auto; width:80%;font-weight:normal;font-family:sans-serif !important;">
			   		<thead>
			   		    <tr> 
			   		    	<th style="font-weight:normal !important;border:1px solid black;border-collapse: collapse;text-align:left;padding-left:5px;">User#</th> 
			   		        <th style="font-weight:normal !important;border:1px solid black;border-collapse: collapse;text-align:left;padding-left:5px;">Name</th> 
			   		    </tr>		   		    
			   		</thead>
			   		<tbody>
   					...
   					{ ?>
   						<tr>
   							<td style="font-weight:normal !important;border:1px solid black;border-collapse: collapse;text-align:left;padding-left:5px;"> <?php echo $userID[$i];?></td>
   							<td style="font-weight:normal !important;border:1px solid black;border-collapse: collapse;text-align:left;padding-left:5px;"> <?php echo $data[$i];?></td> 
   						</tr>
   					<?php }?>
