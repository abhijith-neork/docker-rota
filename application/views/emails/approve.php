...
<br>
        ...
        <?php echo $subject;?><br>
         <p style="padding-left: 20%;">From&nbsp;<?php echo $fromdate;?>&nbsp;To&nbsp;<?php echo $todate;?></p>
		   	   <p style="padding-left: 20%;">Hours:&nbsp;<?php echo $days?><br></p>
		   	   <p style="padding-left: 20%;">Comments:&nbsp;<?php echo $comments;?><br></p>
