...
<br>
        ...
        You recently requested to reset your password for your <strong><?php echo $site_title;?></strong> account.<br>
		        Click the button below to reset it.
		
		   </p>
		    <p style="padding-left: 129px;">
		    	
		    	<a href="<?php echo $url;?>" class="btn btn-danger" style="float:center">Click To Reset Password</a>
		    </p>
