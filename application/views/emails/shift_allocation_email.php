...
<br>
        ...
        <?php $count = count($data) ?>
   			...
   			{ ?>
			   				...
			   				<?php $t_status = 0 ?>
			   				<?php $h_status = 0 ?>
   				<p style="text-align:center;font-weight:normal;font-family:sans-serif !important;">Week <?php echo $j++ ?> </p>
   				<table style="margin:auto;border:solid; width:80%;font-weight:normal;font-family:sans-serif !important;">
			   		<thead>
			   		    <tr> 
			   		        <th style="font-weight:normal !important;border:1px solid black;border-collapse: collapse;text-align:left;padding-left:5px;">Shift Name</th>
			   		...
			   		<tbody>
			   			...
			   			{ ?>
			   			    <tr>
			   			    	<?php if($shift_data[$k]['shift_id'] != 0):?>
			   			        	<td style="font-weight:normal !important;border:1px solid black;border-collapse: collapse;text-align:left;padding-left:5px;"><?php echo findshift($shift_data[$k]['shift_id']);?></td>
			   			        <?php endif;?>		   			        
			   			        ...
			   			        <?php endif;?>
			   			        <?php if($shift_data[$k]['shift_id'] != 0 || $shift_data[$k]['shift_id'] == null):?>
		   		...
		   		<table style="margin:auto;border:solid; width:80%;font-weight:normal;font-family:sans-serif !important;">
		   			<thead>
		   			    ...
		   			    <tbody>
		   			    	<tr>
		   			    		<td style="font-weight:normal !important;border:1px solid black;border-collapse: collapse;text-align:left;padding-left:5px;">
			   			    		<?php if($t_status >= 1):?>
		...
		<!--    <?php // if($recover_url):?>
		   <p style="color: #555555; font-size: 14px;font-family: sans-serif; font-weight: normal; line-height: 1.3em; padding-left: 30px; padding-right: 30px;">You can approve or reject allocation by clicking the below button</p>
		   <?php // endif;?>

		   	<?php // if($recover_url):?>
			   <a href="<?php // echo $recover_url;?>" target="_blank" title=" " style="padding: 7px 40px 7px 40px; margin: auto; display: table;color: #777777; font-size: 15px;font-family:sans-serif, serif; font-weight: normal; border: 1px #00BCD4 solid;-webkit-border-radius: 25px;
-moz-border-radius: 25px;
border-radius: 25px; text-decoration: none; margin-bottom: 35px; margin-top: 35px;">Approve/Reject</a><?php // endif;?> -->
