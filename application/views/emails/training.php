...
<br>
        ...
        <p style="color: #555555; font-size: 14px;  font-weight: normal; line-height: 1.3em; padding-left: 30px; padding-right: 30px;"> </p> 
		   	   <p style="padding-left: 20%;">Title:&nbsp;<?php echo $title;?></p>
		   	   <p style="padding-left: 20%;">Description:&nbsp;<?php echo $comments;?><br></p>
		   	   <p style="padding-left: 20%;">From:&nbsp;<?php echo $fromdate;?>&nbsp;,&nbsp;<?php echo $time_from;?>&nbsp;&nbsp;To:&nbsp;<?php echo $todate;?>&nbsp;,&nbsp;<?php echo $time_to;?></p>
		   	   <p style="padding-left: 20%;">Place:&nbsp;<?php echo $place;?></p> 
		   	   <p style="padding-left: 20%;">Address:&nbsp;<?php echo $address;?></p> 
		   	   <p style="padding-left: 20%;">Point of contact:&nbsp;<?php echo $point_of_person;?></p> 
		   	   <p style="padding-left: 20%;">Contact Number:&nbsp;<?php echo $contact_num;?></p>
		   	   <p style="padding-left: 20%;">Contact Email:&nbsp;<?php echo $contact_email;?></p>
