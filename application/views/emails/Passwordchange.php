...
<br>
	...
	<p style="color: #555555; font-size: 14px;font-family: sans-serif; font-weight: normal; line-height: 1.3em; padding-left: 30px; padding-right: 30px;">Your password has been changed .You can now access your account using following username and password.</p>
		   	<p style="color: #555555; font-size: 14px;font-family: sans-serif; font-weight: normal; line-height: 1.3em; padding-left: 30px; padding-right: 30px;">Username : <?php echo $to;?><br>
