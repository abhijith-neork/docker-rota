...
<br>
           ...
           Your Username:<?php echo $to;?>,
		   Password:<?php echo $password;?> 
		   	<p style="color: #555555; font-size: 14px;font-family: sans-serif; font-weight: normal; line-height: 1.3em; padding-left: 30px; padding-right: 30px;">Please click on the Activate button below and set a new password  to update your new email address.</p>
			   <a href="<?php echo $recover_url;?>" target="_blank" title="<?php echo $site_title;?>" style="padding: 7px 40px 7px 40px; margin: auto; display: table;color: #777777; font-size: 15px;font-family: sans-serif; font-weight: normal; border: 1px #777777 solid;-webkit-border-radius: 25px;
-moz-border-radius: 25px;
border-radius: 25px; text-decoration: none; margin-bottom: 35px; margin-top: 35px;">Activate</a>
