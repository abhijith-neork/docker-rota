...
<br>
        ...
        <?php echo $subject;?><br>
		    <?php foreach ($data as $key=>$value) { if($key!='profile_image'){?>
		   	   <p style="padding-left: 25%;"><?php echo $key;?>:&nbsp;<?php echo $value;?></p>
		   	<?php }else{?>
		   	   <p style="padding-left: 25%;"><?php echo "Profile picture changed.";?></p>
		   	<?php }?>
		   	<?php } ?>
...
Kind Regards,</p>
<p style="font-family: sans-serif;font-size: 12px;font-weight: normal;margin: 0;margin-bottom: 15px; text-align: center;padding: 0px 20px 0px 20px"><?php echo $username ?></p>
<br>
