...
<p style="font-family: sans-serif;font-size: 14px;font-weight: normal;margin: 0;margin-bottom: 15px; text-align:center; padding-top:20px;"><strong>Dear Admin</strong>,<br>
<br>

        <?php echo $subject;?><br>
        <p style="color: #555555; font-size: 14px;font-family: sans-serif; font-weight: normal; line-height: 1.3em; padding-left: 30px; padding-right: 30px;">A new user <?php echo $user_name;?>, with email  <?php echo $email;?> has been registered.</p>
