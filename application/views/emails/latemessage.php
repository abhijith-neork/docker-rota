...
<br>
        ...
        <?php echo $subject;?><br>
        <!-- <p style="padding-left: 20%;">Comments:&nbsp;<?php echo $comment;?><br></p> -->
...
Kind Regards,</p>
<p style="font-family: sans-serif;font-size: 12px;font-weight: normal;margin: 0;margin-bottom: 15px; text-align: center;padding: 0px 20px 0px 20px"><?php echo $user_name ?></p>
<br>
